function spikeTimesAllNeurons = extract_data_from_cl_files_to_variable( flistName, elConfigInfo, varargin)
...
stimStartStop = get_stim_start_stop_ts2(frameno,0.2)/2e4+860/2e4;
    ...
    if ~electrodeIsProcessed
        ...
        try
            ...
            for iLabels = 1:length(goodNeurLabelValues)
                ...
                eval([outputStructName,'.stim_start_stop=stimStartStop;']);
