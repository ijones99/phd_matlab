function play_movie(window, frames, frameCount, frameRate, clipRepeatCount, delayBetweenRepeats, mainSettings)
...
whiteVal = 255; 
darkGrayVal = 115;
grayVal = mainSettings.MID_GRAY_VAL;
lightGrayVal = 205;
...
transScreenDims = [mainSettings.movieEdgeLengthPx mainSettings.movieEdgeLengthPx]; % in pixels
...
beep, pause(.3), beep, pause(.3), HideCursor;
