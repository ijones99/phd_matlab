function [frames frameCount frameNames] = load_im_frames(movieDir, varargin)
...
if isempty(SPEC_FRAME_DIM_PIXELS)
    ...
    if frameCount <= chunkSize
        ...
        % init frames var
        frames = uint8(zeros(600,600,frameCount ));
    ...
    elseif and(frameCount > chunkSize, frameCount <= 1200)
        ...
        % init frames var
        frames = uint8(zeros(600,600,chunkSize ));
        frames2 = uint8(zeros(600,600,frameCount-chunkSize ));
