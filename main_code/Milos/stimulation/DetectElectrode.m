...
while i<=length(varargin)
    if not(isempty(varargin{i}))
        ...
        elseif strcmp(varargin{i}, 'ReadoutBranch5')
            i=i+1;
            ReadoutBranch{5}=varargin{i};
        elseif strcmp(varargin{i}, 'ReadoutBranch6')
            i=i+1;
            ReadoutBranch{6}=varargin{i};
        elseif strcmp(varargin{i}, 'ReadoutBranch7')
            i=i+1;
            ReadoutBranch{7}=varargin{i};
        elseif strcmp(varargin{i}, 'ReadoutBranch8')
            i=i+1;
            ReadoutBranch{8}=varargin{i};
