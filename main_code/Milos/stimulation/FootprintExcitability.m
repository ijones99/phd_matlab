...
function FootprintExcitability(varargin)
...
%     dacselection     =       0;
%     channel          =       stimChNo(1);
%     loop.push_simple_delay(delay*20);
%     loop.push_simple_pulse(Chipaddress, dacselection, volt, Phase/50);
%     loop.flush();                 % send dummy stimulation
