function plot_moving_bars_narrow(Rall, stimChangeTs, stimFrameInfo, clusNumInput,varargin)
...
varIdx = intersect(find(ismember(stimFrameInfo.angle,valAngle)),...
    find(stimFrameInfo.rgb==valRGB(valRGBIdx) & stimFrameInfo.offset==valOffset(valOffsetIdx)));
