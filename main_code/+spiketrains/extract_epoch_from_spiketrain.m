function [spikeTrain spikeTrainZ] = extract_epoch_from_spiketrain(spikeTrain,startTime,endTime, varargin)
...
% select ts to show
spikeTrain = spikeTrain(find(and(spikeTrain>=startTime,spikeTrain<=endTime)));
