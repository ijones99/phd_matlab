function spikecount_moving_bars_spatialtemporal_tuning(Rall, stimChangeTs, stimFrameInfo, clusNum,varargin)
...
offSet=0;
stCurr = spiketrains.extract_st_from_R(Rall, clusNum);

[spikeTrain spikeTrainSeg] = spiketrains.get_raster_series(stCurr/2e4, stimChangeTs/2e4, idxRaster);
