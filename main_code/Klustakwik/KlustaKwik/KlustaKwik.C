...
float PenaltyMix = 1.0;	// amount of BIC to use as penalty, rather than AIC??Why do they use the AIC? Karl Farrow thinks that this is not the best method to use
