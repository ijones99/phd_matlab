...
selEls = [5456];
sort_ums_output(flist, 'add_dir_suffix',suffixName, 'sel_in_dir',5:25)%'all_in_dir'); %,
%% REVIEW CLUSTERS
...
%     textprogressbar(100*find(i==selNeuronInds)/length(selNeuronInds));
    ...
    staOut = white_noise_reverse_correlation_simple( spikeTimes, white_noise_frames, frameInd, ...
