...
%%% %% %% %% %% %% %% %% %% %% %% %% %%  %%   %%     %%    %%   %%  %  % %
%%  Settings
clear all; Info.Exptype='Neur06';
Info.Exptitle='neur06';
dirAllExp = '/home/ijones/Experiments/Recordings';
dirExp = sprintf('%s/18Jun2013',dirAllExp);

Info.Parameter.StimElectrode=2980;
...
Info.Parameter.NumberStim=45; % tells cpp code to look at epochs for averaging
