...
Info.FileName.Spike            = ['~/ln_roska_data/04Jun2013/proc/' Info.Exptitle '.spike'];
Info.FileName.SpikeForm        = ['~/ln_roska_data/04Jun2013/proc/' Info.Exptitle '.spikeform'];
Info.FileName.Map              = ['~/ln_roska_data/04Jun2013/Configs/try01_neuromap.m'];
Info.FileName.Trig             = ['~/ln_roska_data/04Jun2013/proc/' Info.Exptitle '.raw.trig'];
Info.FileName.Raw              = ['~/ln_roska_data/04Jun2013/proc/' Info.Exptitle '.raw'];
Info.FileName.TrigRawAve       = ['~/ln_roska_data/04Jun2013/proc/' Info.Exptitle '.averaged.traw'];
...
Info_Parameter_NumberStim = 30; % tells code to look at DAC channel to determine epoch changes (as opposed to counting num of stim)
