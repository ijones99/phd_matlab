function  paramCat = gather_indices(absDirNames, localDirName, fileName, fieldName, idxParamSettings ) 
...
for iDir = 1:length(absDirNames) % loop through directories
    ...
    clearvars -except iDir absDirNames fileName paramCat localDirName fieldName idxParamSettings
