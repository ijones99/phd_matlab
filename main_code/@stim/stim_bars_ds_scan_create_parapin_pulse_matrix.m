...
save('~/Matlab/settings/stimFrameInfo_movingBar_2reps', 'stimFrameInfo')



%% for 2 reps stim
load ~/Matlab/settings/stimParams_Moving_Bars_2Reps.mat
transMatrix = double(Settings.MID_GRAY_VAL)*double(ones(Settings.SURR_DIMS, ...
    Settings.SURR_DIMS  ));
stimFrameInfo={};
stepCounter = 0;
...
save(fullfile('~/Matlab/settings', 'stimFrameInfo_movingBar_2reps'), 'stimFrameInfo')
