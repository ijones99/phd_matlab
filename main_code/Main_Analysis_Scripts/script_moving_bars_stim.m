...
selEls = [elNumbers];
sort_ums_output(flist, 'add_dir_suffix',suffixName, 'sel_els_in_dir',  3928); %, 'sel_in_dir',1:12
%% REVIEW CLUSTERS
...
plot_raster_for_moving_bar(flistFileNameID, flist, dateValTxt, dirNameFlashingDots, ...
