...
% ---------- Settings ----------
numEls = 7; 
suffixName = '_init_ds_cell_search';
flist = {}; flist_init_ds_cell_search;
...
for i=1:size(fileNames,1)
    ...
    savedFrames = white_noise_reverse_correlation(timeStamps, white_noise_frames,frameno,'draw_aperture');
end
