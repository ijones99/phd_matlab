...
%
    ...
    spikes.params.thresh =4;%normally set to 4            % for 'auto', set number of standard deviations above background noise
 %  spikes.params.thresh =    [-5.3897 -5.0999 -5.1816 -5.5274]; % for 'manual', set specific thresholds for each channel
    ...
    spikes.params.display.isi_bin_size = .25;            % ms, bin width used for ISI histograms
    ...
    % progress_bar
    spikes.params.display.progressbar = 0;
    
    % figure layout
%     spikes.params.display.default_figure_size = [.05 .1 .9 .8];  % location of default figure


    spikes.params.display.default_figure_size = get(0,'ScreenSize');;  % location of default figure
