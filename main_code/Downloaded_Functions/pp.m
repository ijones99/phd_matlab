...
PlotStartFlag = 1;%'';       %This will be an array containing the start points for the plot sections
PlotBreakFlag = 1;%'';       %This will be an array containing the break points for the plot sections
