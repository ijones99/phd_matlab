function [voltThresh xOut yOut ] = get_stim_threshold_v2(m_stim, uniqueVoltages,lookupTbStim, Xread, selStimEl, readoutEl,varargin)
% [voltThresh xOut yOut ] = get_stim_threshold_v2(m_stim, uniqueVoltages,lookupTbStim, Xread, selStimEl, readoutEl,varargin)
...
respPerc = mea1kadd.processing.threshold_responses_v3(uniqueVoltages,lookupTbStim,...
