function plot_space_time_plot_input_spiketrains(stCurr, stimChangeTs_, stimFrameInfo, directionSel, varargin)
% PLOT_SPACE_TIME_PLOT(stCurr, stimChangeTs_, stimFrameInfo, directionSel)
%
% varargin:
