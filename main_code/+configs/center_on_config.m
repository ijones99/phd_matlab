...
dirNameConfig = {...
    ...
    '/home/ijones/Experiments/Configs/Projects/Electrical_Stimulation/30x6_spc1_tile7x14_main_ds_scan/';...
}
for i=1:length(dirNameConfig)
   fprintf('%d) %s\n',i, dirNameConfig{i});
    
end
configSelIdx = input('Select # above >> ');
...
load(fullfile(dirNameConfig{configSelIdx },'configCtrXY'))
...
warning('REMEMBER TO SEND CONFIG TO THE CHIP!!!.\n');
end