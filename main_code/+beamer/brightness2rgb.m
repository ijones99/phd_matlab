function outputRGB = brightness2rgb( percentBrightness, varargin )
...
dirBrightnessMeasurements = ...
    '/home/ijones/Equipment/Beamer/Brightness_Info/11Apr2014/';
...
junk = input(sprintf('Using %s for conversion.\nok?', fullfile(dirBrightnessMeasurements,fileNamePercentVal)),'s');
