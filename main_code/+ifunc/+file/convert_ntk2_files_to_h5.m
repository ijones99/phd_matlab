...
roskaDir = '/net/bs-filesvr01/export/group/hierlemann/recordings/HiDens/SpikeSorting/Roska/';
% expDirNames = { ...
%     '30Oct2012'; ...
%     '20Dec2012'; ...
%     '13Dec2012_2'; ...
...
% '10Apr2013';
%     }
if ~iscell(expDirNames)
    expDirNamesTxt = expDirNames; clear expDirNames;
    expDirNames{1} = expDirNamesTxt;
end
for i=1:length(expDirNames)
    tic
    % set proc dir location
    dirProc = fullfile( roskaDir,expDirNames{i},'proc/')
    
    % set hdf dir location
    dirHdf5 = fullfile( roskaDir,expDirNames{i},'hdf5/')
