function calc_and_save_sta_noise_movie(dirName, neurNames, flistFileNameID, hdmea, frameno, varargin)
...
P.save_plot_info = 1;
P.save_temporal_plot = 1;
P.structure_name = 'Noise_Movie';
P.use_sep_dir = 'Noise_Movie';
P.restrict_spike_number = [];
P.num_waveforms_to_use = [];
P.restrict_spike_number_lower_res = [];
...
for i=1:length(neurNames)
    try
        ...
        [staFrames staTemporalPlot plotInfo ] = ifunc.sta.make_sta_noise_movie( spikeTimes, dirName.noise_movie_frames, ...
