function drifting_linear_pattern(inputLine, speedPxPerSec, movieDurationSecs)
...
visiblesize=2^10;        % Size of the grating image. Needs to be a power of two.
...
while(vbl < vblendtime)
   ...
   %Screen('DrawTexture', w, gratingtex, srcRect);
    ...
    Screen('DrawTexture', w, gratingtex, srcRect, [], 30);
