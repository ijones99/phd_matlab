function stim_bars_ds_scan_v2( w,Settings,screenRect )
                    ...
                    for iBarWidth = 1:length(Settings.BAR_WIDTH)
                        ...
                        for iVel = 1:length(Settings.SPEED)
                            ...
                            for iAngle = 1:length(Settings.DIRECTIONS)
                                ...
                                barDimY1 = max(round(vertScrDim/2)-round(barWidthPx/2), 1);
                                barDimY2 = min(round(vertScrDim/2)+round(barWidthPx/2), blankBarY);
