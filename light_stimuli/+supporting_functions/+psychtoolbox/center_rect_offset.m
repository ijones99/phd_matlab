function [rect,dh,dv] = center_rect_offset(rect,fixedRect, offset)
...
dv=(fixedRect(RectTop)+fixedRect(RectBottom)-rect(RectTop)-rect(RectBottom))/2+offset(1);
dh=(fixedRect(RectLeft)+fixedRect(RectRight)-rect(RectLeft)-rect(RectRight))/2+offset(2);
dv=round(dv);
dh=round(dh);
